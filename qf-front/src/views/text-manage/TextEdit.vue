<template>
	<div>
		<el-page-header content="编辑文章"  title="文章管理" @back="handleBack()"/>
		<el-form
			ref="txtFormRef"
			:model="txtForm"
			:rules="txtFormRules"
		...
		>
			...
			<el-form-item label="内容" prop="content">
				<editor @event="handleChange" :content="txtForm.content" v-if="txtForm.content"/>
			</el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" @click="submitForm()">修改文章</el-button>
      </el-form-item>
		</el-form>
	</div>
</template>
